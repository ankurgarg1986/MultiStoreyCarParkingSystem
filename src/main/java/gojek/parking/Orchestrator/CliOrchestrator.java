...
/**
 * Orchestrator class to convert/call the ParkingManager API's and call the builder to build the final Response It takes
 * the input from command line , and calls the main contract. If there is any dependency that needs to be created to
